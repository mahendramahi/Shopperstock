 ...
 */
public class MyFragmentPager extends Fragment {
    ...
    public MyFragmentPager() {

        //  country = new ResponseDataArray();

    }

    public MyFragmentPager(int index) {
        mIndex = index;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  if (mIndex == 3) {
            v = inflater.inflate(R.layout.layout_header_fram,
                    container, false);

        ImageView imageheader = (ImageView) v.findViewById(R.id.imageheader);

        imageheader.setBackgroundResource(R.drawable.userbg);
